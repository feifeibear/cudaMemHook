...
inline void MallocReply::_internal_set_mem_handle(const std::string& value) {
  ...
  mem_handle_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void MallocReply::set_mem_handle(const char* value) {
  ...
  mem_handle_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:MallocReply.mem_handle)
}
inline void MallocReply::set_mem_handle(const void* value,
    size_t size) {
  
  mem_handle_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
...
inline std::string* MallocReply::_internal_mutable_mem_handle() {
  ...
  return mem_handle_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
